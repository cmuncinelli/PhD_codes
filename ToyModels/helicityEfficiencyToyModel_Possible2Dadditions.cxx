...
//   pRingProxyJetVsEtaJetVsEtaLambda -- TProfile2D: jet proxy study of jet eta and Lambda eta correlation (shouldn't be any)
...
struct ScenarioHistos {
    ...
    TProfile2D* pRingProxyJetVsEtaJetVsEtaLambda;// <R_proxyJet> vs Jet pseudorapidity vs Lambda pseudorapidity
    ...
    FlatRing2D<20, 20> flatRingJetVsEtaJetVsEtaLambda; // 2D correlation, related to pRingProxyJetVsEtaJetVsEtaLambda
...
static ScenarioHistos BookScenario(TDirectory* dir, double etaMinDetector, double etaMaxDetector)
{
    ...
    h.pRingProxyJetVsEtaJetVsEtaLambda = new TProfile2D("pRingProxyJetVsEtaJetVsEtaLambda", "<R_{proxyJet}> vs Jet vs Lambda; #eta_{Jet}; #eta_{#Lambda};<R_{proxyJet}>", 20, etaMinDetector, etaMaxDetector, 20, etaMinDetector, etaMaxDetector);
...
static void SyncScenarioFlatToROOT(ScenarioHistos& h)
{
    ...
    // Ring proxy vs Lambda eta: r-channel (the Z direction as proxy) --> pRingProxyVsEta, rjet-channel --> pRingProxyJetVsEta
    ...
    // Ring proxy jet vs jeta eta vs Lambda eta:
    SyncRing2DToROOT(h.flatRingJetVsEtaJetVsEtaLambda,
                     h.pRingProxyJetVsEtaJetVsEtaLambda)
}
